...
function NewVideo() {
    ...
    const handleConfirmSave = () => {
        addVideo(formData);
        setNotificationMessage('Successfully added video card.');
        ...
        <div className="new-video-page">
            <div className="container__new-video">
                <header className="new-video__header">
                    <h1 className="new-video__title">ADD VIDEO</h1>
                    <p className="new-video__description">
                        PLEASE COMPLETE FORM TO ADD A NEW VIDEO CARD
                    </p>
                </header>
                <form className="new-video__form" onSubmit={handleSave}>
                    <div className="form-section">
                        <div className="form-section__left">
                            <h2 className="new-video__form-title">Create card</h2>
                        </div>
                    </div>
                    <div className="form-section">
                        <div className="form-section__left">
                            <label className={`new-video__form-label ${errors.title && touchedFields.title ? 'error-label' : ''}`}>
                                ...
                                <input
                                    ...
                                    type="text"
                                    placeholder='Title of video goes here'
                                    name="title"
                        ...
                        <div className="form-section__left">
                            <label className={`new-video__form-label ${errors.photo && touchedFields.photo ? 'error-label' : ''}`}>
                                ...
                                <input
                                    ...
                                    type="url"
                                    placeholder='Link of image goes here'
                                    name="photo"
            ...
            {showConfirmation && (
                <ConfirmationDialog
                    message={`Are you sure you want to add video card?`}
